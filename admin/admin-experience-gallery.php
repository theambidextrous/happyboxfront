    ...
    <body>
        ...
        <section class=" data+table_section ">
            ...
            <div class="row ">
                    <div class="col-md-12 ">
                        <br><br>
                        <h4 class="filter_title text-center">Add Gallery to Experience 
                    ...
                    <div class="col-md-7 ">
                        <?php 
                            ...
                            if( isset($_POST['upload'])){
                                try{
                                    $_SESSION['frm'] = $_POST;
                                    $pc = new Picture($_REQUEST['exp'], 'path_name', $_POST['type']);
                ...
                <div class="row ">
                    <div class="col-md-12 ">
                        <br><br>
                        <h4 class="filter_title text-center">Galleries for this Experience 
                        </h4>
                    </div>
                    <div class="col-md-12 ">
                        <div class="table-responsive">
                            <table class="table table_data1 table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $exp_media = json_decode($picture->get_byitem($token, $_REQUEST['exp']), true)['data'];
                                    // $util->Show($exp_media);
                                    if(!empty($exp_media)){
                                    ...
                                    <tr>
                                        ...
                                        <td class="inner_table_wrap">
                                            <table class="text-white inner_table">
                                                <tr>
                                                    <td class="td_b">
                                                        <a href="admin-experience-gallery.php?action=del&&mt=<?=$tpc['id']?>" class="light">Delete</a> 
                                                    </td>
                                                </tr>
                                            </table>  
                                        </td>
