			...
			<div class=" ">
				...
				<form class="form_register_user" name="ship_frm" id="ship_frm">
					<div class="form-group">
						...
						<input type="text" name="address" id="a_address" class="form-control rounded_form_control" value="<?=$shipping_->address?>">
						<?=$util->place_autocomplete('a_address')?>
					</div>
					<div class="form-group">
						<label>City</label>
		...
		<div class="modal-content">
			<div class="modal-body text-center">
				<div class="col-md-12 text-center forgot-dialogue-borderz">
					...
					<div>
						<img src="<?=$util->AppHome()?>/shared/img/btn-okay-orange.svg" class="img-btn password_ok_img" data-dismiss="modal"/>
					</div>
				</div>
			</div>
		</div>
