			...
			<div class="card user_login_card user_create_l">
				<div class="card-body text-center">
					...
					<div class="step_div">
						...
						<img src="<?=$util->AppHome()?>/shared/img/choose_what.svg" class="w-100"/>
					</div>
					<div class="step_div">
						<p> CHOOSE <strong>WHERE</strong> </p>
						<img src="<?=$util->AppHome()?>/shared/img/choose_where.svg" class="w-100"/>
					</div>
					<div class="step_div">
						<p> CHOOSE <strong>WHEN</strong> </p>
						<img src="<?=$util->AppHome()?>/shared/img/choose_when.svg" class="w-100"/>
					</div>
					<div class="step_div">
						<p> <span class="unique-font">Choose</span> <span class="special-font"><strong>HAPPYBOX</strong></span> </p>
						<img src="<?=$util->AppHome()?>/shared/img/choose_happy.svg" class="w-100"/>
					</div>
				</div>
			</div>
		...
		<div class="modal-content">
			<div class="modal-body text-center">
				<div class="col-md-12 text-center forgot-dialogue-borderz">
					...
					<div>
						<img src="<?=$util->AppHome()?>/shared/img/btn-okay-blue.svg"  class="password_ok_img" data-dismiss="modal" onclick="javascript:window.location='user-login.php'"/>
					</div>
				</div>
			</div>
		</div>
