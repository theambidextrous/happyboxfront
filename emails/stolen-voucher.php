    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin:0 auto;padding:0; font-family: Calibri;font-size: 14px;">
        <div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0; overflow-x: hidden;">
            ...
            <div style="width:80%; margin: 24px auto;" >
                ...
                <img src="http://localhost/happyboxfront/emails/img/declare.svg" alt="" style="width: 100%;">
            </div>
               <div style="width:80%; margin: 10px auto; text-align: center;" >
                   <p>
          You recently declared the loss or theft of your HappyBox voucher.
                   </p>
                   <p>Upon receipt of your claim, HappyBox immediately blocked the use of the said voucher and it is now totally void. 
                   </p><p>We have confirmed the voucher was not redeemed prior to your loss or theft declaration and we are pleased to provide you with a replacement voucher.
                       </p><p>This voucher is to be used in place of the one you have misplaced, it takes the form of an e-voucher, and is attached to this message.        
