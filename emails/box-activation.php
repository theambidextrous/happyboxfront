...
<div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0;overflow-x:hidden;">
	<div style="width:100%;">
		<a href="https://happybox.ke/" target="_blank"> <img src="img/customer_head.svg" alt="" style="padding-bottom:0px;width:100%;"></a>
	</div>
	<div style="width:80%;margin:10px auto;" class="mob_100">
		<h3 style="font:normal normal bold 20px/24px Calibri;letter-spacing:0px;color:#00ACB3;opacity:1;text-align:center;">Dear [Customer Name]</h3>
	</div>
	<div style="width:80%;margin:18px auto;" >
		<img src="img/congrat.svg" alt="" style="width:100%;">
	</div>
	...
	<div style="width:80%;margin:10px auto;text-align:center;" >
		<table style="width:80%;color:#FA683D;margin:10px auto 40px;" >
			<tr>
				<td style="vertical-align:middle;width:9%;"><img src="img/box_1.svg" alt="" style=""></td>
				<td style="vertical-align:middle;"><strong>SELECT</strong> one experience in the booklet or e-booklet </td>
			</tr>
			<tr >
				<td style="vertical-align:middle;width:9%;"><img src="img/box2.svg" alt="" style=""></td>
				<td style="vertical-align:middle;"><strong>BOOK</strong> your experience with the chosen partner </td>
			</tr>
			<tr>
				<td style="vertical-align:middle;width:9%;"><img src="img/box3.svg" alt="" style=" ;"></td>
				<td style="vertical-align:middle;"><strong>SHARE</strong> your voucher code with them </td>
			</tr>
			<tr>
				<td style="vertical-align:middle;width:9%;"><img src="img/box4.svg" alt="" style=""></td>
...
<h4><span style="color:#00ACB3">Your</span> <span style="font:normal normal bold 20px/26px Agency FB;letter-spacing:0px;color:#C20A2B;opacity:1;">HAPPYBOX</span>  <span style="color:#00ACB3">Customer Care Team</span></h4>
	...
	<div style="width:100%">
		<div style="">
			<a href="https://happybox.ke/staging/clt-src-hb/" target="_blank"><img src="img/news_see_you_soon.svg" style="margin:0px auto;padding-top:20px;" alt=""></a>
		</div>
	</div>
	<div style="width:100%">
		<div style="">
