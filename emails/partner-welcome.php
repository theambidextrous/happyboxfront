...
<div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0;overflow-x:hidden;">
	<div style="width:100%;">
		<a href="https://happybox.ke/" target="_blank"> <img src="img/on_boarding_header.svg" alt="" style="padding-bottom:15px;width:100%;"></a>
	</div>
	...
	<div style="width:80%; margin:18px auto;" >
		<img src="img/congrats_partnerwelcome.svg" alt="" style="width:100%;">
	</div>
	...
	<div style="width:80%;margin:10px auto;" >
		<table align='center' style="text-align:center;">
			<tr>
				<td style="width:50%;padding-top:30px;vertical-align:top;"><img src="img/icn-functions-03-teal.svg" alt="" style="margin:5px auto;">
				...
				<td style="padding-top:30px;vertical-align:top;"><img src="img/icn-functions-02-orange.svg" alt="" style="margin:5px auto;">
					<p style="color:#FA683D;"> Keep track of the vouchers redeemed <br>
						in your business, and payments made<br>
						to you. </p></td>
			</tr>
			<tr>
				<td style="padding-top:30px;vertical-align:top;"><img src="img/icn-functions-01-blue.svg" alt="" style="margin:5px auto;">
					<p style="color:#0185B6;"> Monitor the services you have<br>
						allocated to each box. </p></td>
				<td style="padding-top:30px;vertical-align:top;"><a href="https://happybox.ke/staging/ptn-src-hb/login.php" target="_blank"> <img src="img/btn-partner-login.svg" alt="" style="margin:5px auto;"> </a></td>
			</tr>
		</table>
	</div>
	<div style="width:80%;margin:10px auto;" class="mob_100">
		<div style="">
			<a href="https://happybox.ke/staging/clt-src-hb/" target="_blank"><img src="img/need_help.svg" style=" margin:0px auto;padding-top:30px;" alt=""></a>
		</div>
	</div>
	<div style="width:80%;margin:10px auto;" class="mob_100">
	...
	<div style="width:80%;margin:10px auto;" >
		<table align="center"  style="width:100%;">
			<tr>
				<td style="width:50%;padding-top:2px;vertical-align:top;" align="center"><img src="img/icn-mail-blue.svg" alt="" style="margin:5px auto;">
					<p > <b><a style="color:#0185B6;text-decoration:none;" href="mailto:partnercare@happybox.ke">partnercare@happybox.ke</a></b> </p></td>
				<td style="padding-top:2px;vertical-align:top;" align="center"><img src="img/icn-phone-blue.svg" alt="" style="margin:5px auto;">
					<p > <b><a href="tel:254722463498" target="_blank" style="color:#0185B6;text-decoration:none;">+254 722 463 498</a></b> </p></td>
			</tr>
		</table>
	</div>
	<div style="width:80%; margin:50px auto 14px;">
		<img src="img/onboarding_your.svg" alt="" style="margin:33px auto 4px;">
	</div>
	<div style="width:100%">
		<div style="">
	...
	<div style="width:100%">
		<div style="">
			<img src="img/news_below_see_you.png" style=" margin:0px auto;width:100%;" alt="">
		</div>
	</div>
	<div style=" width:80%;
