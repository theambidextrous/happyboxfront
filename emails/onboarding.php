    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin:0 auto;padding:0; font-family: Calibri;font-size: 14px;">
        <div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0; overflow-x: hidden;">
            ...
            <div style="width:80%;     margin: 18px auto;;" >
                ...
                <img src="http://localhost/happyboxfront/emails/img/onboard_img2.svg" alt="" style="width: 100%;">
            </div>
               <div style="width:80%; margin: 10px auto; text-align: center;" >
                   <p>
                       We have received your information and our partner care team is reviewing your application. </p><p> We will get in touch with you should we require any further details and will contact you shortly to confirm your partner status.
             ...
             <div style="width:80%; margin: 10px auto;" >
                ...
                <img src="http://localhost/happyboxfront/emails/img/onboarding_your.svg" alt="" style="margin: 14px auto;">
            </div>
