    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin:0 auto;padding:0; font-family: Calibri;font-size: 14px;">
        <div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0; overflow-x: hidden;">
            ...
            <div style="width:80%; margin: 24px auto;" >
                ...
                <img src="http://localhost/happyboxfront/emails/img/welcome_cong.svg" alt="" style="width: 100%;">
            </div>
               <div style="width:80%; margin: 10px auto; text-align: center;" >
                   <p>
                       You now have access to an easy going gifting experience.  </p>
                   <p>Through your account you can:
             ...
             <table  style="margin-top:20px; margin-bottom: 40px;" >
                    ...
                    <tr>
                         <td style="width:12%;vertical-align: middle;">                          
                           <img src="http://localhost/happyboxfront/emails/img/icn-partner-portal-function-03.svg" alt="" style="">                    
                        </td>
                        <td style="vertical-align: middle;">
                        <p style="color:#0185B6;padding-left: 7px;">
                     Monitor the boxes you have been gifted and check your order history.
                           </p>
                        </td> </tr>
                    <tr>
                      ...
                      <tr>
                         <td style="width:12%;vertical-align: middle;">                          
                           <img src="http://localhost/happyboxfront/emails/img/icn-partner-portal-function-01.svg" alt="" style="">                    
                        </td>
                        <td style="vertical-align: middle;">
                        <p style="color:#00ACB3;padding-left: 7px;">
                Look up all the partners that correspond to your boxes.
                           </p>
                        </td> </tr>
                        <tr>
                        <td colspan="2" style="height:20px">                          
                         ...
                         <tr>
                         <td style="width:12%;vertical-align: middle;">                          
                           <img src="http://localhost/happyboxfront/emails/img/welcom_3.png" alt="" style="">                    
                        </td>
                        <td style="vertical-align: middle;">
                        <p style="color:#FA683D;padding-left: 7px;">
            Give us your feedback on the experiences you have enjoyed, because <br>your feedback is paramount to us.
                           </p>
                        </td> </tr>
             ...
             <div style="width:80%; margin: 10px auto;">
                 <p style="text-align:center;">
                     Click on the link below to activate your account and start enjoying your<br> HappyBox experience!  
                 </p>

            </div>
             <div style="width:100%">
                <div style="">
                    <img src="http://localhost/happyboxfront/emails/img/btn-user-activate.svg" style=" margin: 11px auto; height: 56px;" alt="">
                </div> 
