    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin:0 auto;padding:0; font-family: Calibri;font-size: 14px;">
        <div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0; overflow-x: hidden;">
            ...
            <div style="width:80%; margin: 10px auto;">
                ...
                <h4><span style="color: #0985B6">The</span> <span style="font: normal normal bold 22px/26px Agency FB;letter-spacing: 0px;color: #C20A2B;opacity: 1;">HAPPYBOX</span>  <span style="color: #0985B6">Team</span></h4>
                    ...
                    <table style="width:100%;">              
                        <tr>
                            ...
                            <td align="right">
                                ...
                                <a href="https://happybox.ke/staging/clt-src-hb/category-well-being.php" target="_blank"> <img src="http://localhost/happyboxfront/emails/img/read_more.png" alt=""></a>
            ...
            <div style="width:100%;">   
                <img src="http://localhost/happyboxfront/emails/img/news_experience_ofmonth.svg" style="float: right;  margin-right: -17px; margin-top: 34px;" alt="">


            </div>
            <div style="width:100%;">   
                <img src="http://localhost/happyboxfront/emails/img/expe_image.png" style="" alt="">


            </div>
            <div style="width:80%; margin: 0px auto;">   
                <h3 style="font: normal normal bold 24px/39px Segoe Script;letter-spacing: 0px;color: #FA683D">Find this experience …</h3>
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elementum id leo eu pulvinar. Duis condimentum mi at enim viverra, vitae accumsan ipsum laoreet. Quisque a posuere massa. Praesent consectetur efficitur lectus. Sed laoreet pretium leo, non euismod mi. Cras aliquet, diam ac dictum hendrerit, ex neque commodo.   
                </p>
            ...
            <div style="width:100%">
                <div style="">
                    <a href="https://happybox.ke/staging/clt-src-hb/" target="_blank">   <img src="http://localhost/happyboxfront/emails/img/btn-buy-box.svg" style="margin: 16px auto;" alt=""></a>
                </div> 

            </div>
            <div style="width:100%">
                <div style="">
                    <img src="http://localhost/happyboxfront/emails/img/tips.svg" style=" margin-left: -22px;" alt="">
                </div> 
            ...
            <div style="width:100%">
                <div style="width:50%;float: left">
                    ...
                    <p>
                        <a href="https://happybox.ke/staging/clt-src-hb/category-well-being.php" target="_blank"> 
                            <img src="http://localhost/happyboxfront/emails/img/news_browse.svg" style=" margin: 1px auto;" alt="">
                        </a>
                    </p>
            ...
            <div style="width:100%">
                <div style="">
                    <a href="https://happybox.ke/staging/clt-src-hb/" target="_blank"><img src="http://localhost/happyboxfront/emails/img/news_see_you_soon.svg" style="    margin: 0px auto;    padding-top: 30px;" alt=""></a>
                </div> 

            </div>
            <div style="width:100%">
                <div style="">
                    <img src="http://localhost/happyboxfront/emails/img/news_below_see_you.png" style=" margin: 0px auto;" alt="">
                </div> 
