...
<div border="0" cellpadding="0" cellspacing="0" style=" max-width:800px;width:100%;margin:0 auto;padding:0;overflow-x:hidden;background:#fff;margin-top:36px;">
	<div style="width:90%;margin:auto;padding-top:12px;padding-bottom:12px;" class="mob_100">
		<table style="width:100%;border:none;" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="vertical-align:middle;" alig="right"><img src="img/happy_logo.svg" alt="" style=" width:auto;float:right;height:70px;"/></td>
			</tr>
		</table>
	</div>
	<div style="width:90%;margin:auto;padding-top:12px;padding-bottom:12px;" class="mob_100">
		<table style="width:100%;border:none;margin-bottom:50px;" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="width:35%;vertical-align:top;" alig="right"><span style="margin-bottom:8px;display:block;background:#00acb3;color:white;font-weight:bold;padding:7px 30px;border-radius:7px;">BILL TO </span> <span style="font-size:20px;font-weight:bold;">Name of the Buyer</span><br>
 ...
 padding:2px 8px;">Thank you for your business! </span></td>
		...
		<div style="width:100%;margin:auto;color:#999999;padding-top:98px;text-align:center;" class="mob_100">
			...
			<p> by email <a href="mailto:customerservices@happybox.ke" style="color:#999999;">customerservices@happybox.ke</a> or by phone <a style="color:#999999;" href="tel:254112454540">+254 112 454 540 </a> </p>
		</div>
	</div>
</div>
</body>
