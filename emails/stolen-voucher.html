...
<div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0;overflow-x:hidden;">
	...
	<div style="width:80%;margin:24px auto;" >
		<img src="img/declare.svg" alt="" style="width:100%;">
	</div>
	...
	<div style="width:100%">
		<div style="">
			<a href="https://happybox.ke/staging/clt-src-hb/user-dash-activate-voucher.php" target="_blank"> <img src="img/btn-register-your-voucher.svg" style=" margin:25px auto;height:44px;" alt=""> </a>
		</div>
	</div>
