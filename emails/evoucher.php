...
border-bottom-left-radius:18px;">
	<div style="width:100%;margin:10px auto;" class="mob_100">
		<img src="img/hb-logo-red_1.svg" alt="" style=" margin:34px auto 20px;">
	</div>
	<div style=" width:93%;margin:10px auto;" class="mob_100">
		<h3 style="text-align:center;font:normal normal bold 20px/24px Calibri;letter-spacing:0px;color:#00ACB3">Dear [Customer Name]</h3>
	</div>
	<div style=" width:93%;margin:24px auto -2px;" >
		<img src="img/your_evoucher.svg" alt="" style="width:100%;">
	</div>
	<div style="width:100%;" >
		<img src="img/rect_evoucher.svg" alt="" style="width:100%;">
	</div>
	<div style=" width:93%;margin:0px auto 10px;" >
		<img src="img/this_gift.svg" alt="" style="margin:auto;"> <h2 style="text-align:center;font:normal normal bold 26px/19px Calibri;letter-spacing:0px;color:#000000;margin-top:54px;">Joe Bloggs</h2>
	</div>
	...
	<div style=" width:93%;margin:60px auto 40px;background:#FFFFFF 0% 0% no-repeat padding-box;box-shadow:0px 3px 8px #00000029;" >
		<div style="width:100%;position:relative;">
			<img src="img/post_card.svg" alt="" style="position:absolute;right:0px;top:-57px;">
		</div>
		<div style=" padding:69px 20px 24px;">
			<h3 style="font:normal normal bold 20px/19px Segoe Script;letter-spacing:0px;color:#C20A2B;">Dear Recipient</h3>
			<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elementum id leo eu pulvinar. Duis condimentum mi at enim viverra, vitae accumsan ipsum laoreet.</p>
			<p> Quisque a posuere massa. Praesent consectetur efficitur lectus. Sed laoreet pretium leo, non euismod mi. </p>
		</div>
	...
	<div style="width:100%;margin:0px auto 10px;" >
		<img src="img/below_dear.svg" alt="" style="width:100%;">
	</div>
	<div style=" width:93%;margin:0px auto 10px;" >
		<table>
			<tr>
				<td style="width:30%"><img src="img/Box_Mockup_01-200x200@2x.png" alt="" style="width:100%;"></td>
				<td style=" padding-left:14px;"><h3 style="text-align:left;font:normal normal bold 20px/24px Calibri;letter-spacing:0px;color:#C20A2B">BOX NAME</h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elementum id leo eu pulvinar. Duis condimentu mi at enim viverra, vitae accumsan ipsum laoreet.</p>
					<p> Quisque a posuere massa. Praesent consectetur efficitur lectus. Sed laoreet pretium leo, non euismod mi. Cras aliquet, diam ac dictum hendrerit, ex neque commodo.</p></td>
			</tr>
		</table>
	</div>
	<div style=" width:93%;margin:0px auto 10px;" >
	...
	<div style="width:100%">
		<div style="">
			<img src="img/voucher_bottom.png" style=" margin:0px auto;" alt="">
		</div>
	</div>
	<div style="width:93%;margin:auto;color:#707070;">
		...
		<p style="text-align:center;"> Early activation of your e-voucher on <strong><a href="https://happybox.ke/staging/clt-src-hb/user-dash-activate-voucher.php" target="_blank" style="text-decoration:none;"><span style="color:#707070;">happybox.ke</span></a></strong> allows you to benefit from our loss and theft warranty, you will also be able to check the validity status of your e-voucher. </p>
...
margin:auto;" class="mob_95">
		<div style="width:50%;float:left">
			<img src="img/hb-alt-logo-white.svg" style=" display:inline;" alt=""> <img src="img/Chooseyourgift.svg" style=" display:inline;" alt="">
		</div>
		<div style="width:50%;float:left;text-align:right;">
			<a href="https://www.facebook.com/HappyBoxke-104873668046223" target="_blank"><img src="img/icn-fb-white.svg" style=" display:inline;height:26px;margin-left:19px;" alt=""></a> <a href="https://www.instagram.com/happybox.ke/" target="_blank"><img src="img/icn-ig-white.svg" style="display:inline;height:26px;margin-left:19px;" alt=""></a> <a href="https://www.linkedin.com/company/happybox-ke/" target="_blank"><img src="img/icn-li-white.svg" style="display:inline;height:26px;margin-left:19px;" alt=""></a>
		</div>
	</div>
</div>
