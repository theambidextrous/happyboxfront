    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin:0 auto;padding:0; font-family: Calibri;font-size: 16px;">
        <div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0; overflow-x: hidden;">
            ...
            <div style="width:80%;     margin: 18px auto;;" >
                ...
                <img src="http://localhost/happyboxfront/emails/img/customer_welcome.svg" alt="" style="width: 100%;">
            </div>
            <div style="width:80%; margin: 10px auto; text-align: center;" >
                      
                <p>
                    We are pleased to inform you that your payment has been confirmed<br>
and your order is recorded.   
                </p>
                <p>
                    E-Voucher(s) are sent by email shortly after purchase, and<br>
Physical Box(es) are delivered to the specified address the following day<br>
before noon except on Sunday. 
                </p>
                 <p>
                     Find your invoices at any time on your HappyBox Account,<br>
under My Purchase History. 
                </p>
                <p>
 ...
 <div style="width:80%; margin: 10px auto 1px; text-align: center;">
              ...
              <h4><span style="color: #0985B6;font-size: 20px;">The</span> <span style="    font: normal normal bold 29px/26px Agency FB;letter-spacing: 0px;color: #C20A2B;opacity: 1;">HAPPYBOX</span>  <span style="color: #0985B6;    font-size: 20px;">Team</span></h4>
            </div>
