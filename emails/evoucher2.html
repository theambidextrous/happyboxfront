...
<div border="0" cellpadding="0" cellspacing="0" style=" max-width:800px;width:100%;margin:0 auto;padding:0;overflow-x:hidden;background:#fff;margin-top:36px;">
	<div style="width:60%;margin:auto;" class="mob_100">
		...
		<img src="img/happybox-voucher-cover-img-r@2x.png" alt="" style=" margin:auto;">
	</div>
	<div style="background:#C20A2B;width:100%;height:10px;position:relative;" >
		<img src="img/voucher2_gift.svg" alt="" style=" width:auto;
background:#c20a2b;
padding:10px;
border-radius:50%;
position:absolute;
			...
			<tbody>
				<tr>
					...
					<td style="vertical-align:middle;"><p style="padding-left:7px;"> <span style="color:#C20A2B;"> <strong>ACTIVATE</strong></span> your voucher early on <a href="https://happybox.ke/" target="_blank" style="text-decoration:none;font-weight:bold;"><span style="color:#C20A2B;">happybox.ke</span></a> in the<br>
							<a href="https://happybox.ke/staging/clt-src-hb/user-dash-activate-voucher.php" style="text-decoration:none;font-weight:bold;" target="_blank"><span style="color:#C20A2B;">register your voucher </span></a> section </p></td>
				</tr>
				<tr>
					<td colspan="2" style="height:20px"></td>
				</tr>
				<tr>
					<td style="width:12%;vertical-align:middle;"><img src="img/step2.svg" alt="" style=""></td>
				...
				<tr>
					<td style="width:12%;vertical-align:middle;"><img src="img/step3.svg" alt="" style=""></td>
