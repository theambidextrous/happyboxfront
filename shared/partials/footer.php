...
<footer class="text-white upper_footer">
	<div class="container">
		<div class="row ">
			...
			<div class="col-md-6 text-center upper_footer_col2">
				<li><a href="<?=$util->ClientHome()?>"><img class="" src="<?=$util->ClientHome()?>/shared/img/inverse-logo.png"></a></li>
			</div>
	...
	<div class="row lower_footer">
		<div class="col-md-12 text-center">
			<!--    <span class="copy_sign"> </span> --><span class="copy_text">&copy;  <?=date('Y')?> HAPPYBOX</span> <a href="#top" id="goTop"> <img class="" src="<?=$util->ClientHome()?>/shared/img/icons/back_top.svg"></a>
		</div>
	</div>
</footer>
