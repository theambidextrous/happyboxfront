...
$_t = new Topic();
$topic_selected_ = $util->AppWellBeing();
$util->ShowErrors(1);
...
<meta name="description" content="Need to disconnect and recharge? Discover our exclusive selection of dream spas, relaxing beauty treatments and yoga classes, guaranteed to leave you feeling calm, restored and revitalised.">
<meta name="robots" content="index, follow">
<link rel="canonical" href="https://happybox.ke/category-well-being.php">
<meta property="og:locale" content="en_US">
<meta property="og:type" content="website">
<meta property="og:title" content="HappyBox">
<meta property="og:description" content="Need to disconnect and recharge? Discover our exclusive selection of dream spas, relaxing beauty treatments and yoga classes, guaranteed to leave you feeling calm, restored and revitalised.">
<meta property="og:url" content="https://happybox.ke/category-well-being.php">
      ...
      <div class="row justify-content-end">
        <div class="col-md-5 text-md-right">
          ...
          <div class="well_scroll text-center">
            <img class="" src="<?= $util->AppHome() ?>/shared/img/icn-arrow-yellow.svg">
          </div>
  ...
  <section class="mobile_view">
    <div class="container samsung_container  no_pad_lr_mob">
      <div class="row justify-content-center">
        ...
        <div class="">
          <img class="w-100" src="<?= $util->AppHome() ?>/shared/img/wellbeingbg_mob.png">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <p class="text-right rating_bar">
                          <img src="<?= $util->AppHome() ?>/shared/img/icons/yellow_star.svg" class="">
                          <img src="<?= $util->AppHome() ?>/shared/img/icons/yellow_star.svg" class="">
                          <img src="<?= $util->AppHome() ?>/shared/img/icons/yellow_star.svg" class="">
                          <img src="<?= $util->AppHome() ?>/shared/img/icons/yellow_star.svg" class="">
                          <img src="<?= $util->AppHome() ?>/shared/img/icons/yellow_star_empty.svg" class="">
                        </p>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table class="cat_well_table table table-bordered">
                    <tr class="">
                      <td class="td_cat_a">
                        <table>
                          <tr>
                            <td class="inner_td_gray height_mob ">
                              <h6>
                                <?= $_all_ptn['business_name'] ?>
                              </h6>
                            </td>
                          </tr>
                          <tr>
                            <td class="inner_light_blue height_mob">
