          ...
          if ($box_voucher_status == 3) {
           ...
           $admin_func = ' <td class="hap_danger hap_desk">
                      ...
                      <td id="datepilckerx" class="hap_primary">
                       <button type="button" class="modify_img_btn" title="Click the field below to pick the new date">MODIFY DATE  <img src="../shared/img/icons/icn-edit-teal.svg" class="td_edit_img mobile"/></button>
                      <input autocomplete="off" type="text" class="datepicker" name="newdate" placeholder="" onchange="modify_date(this.value,' . $m_voucher . ',' . $m_partner . ')"></td>';
     ...
     <div class="col-md-12 ">
       ...
       if ($box_voucher_status == 3) {
        ...
        $admin_func = ' <td class="v_td_canc">
                ...
                <td id="datepilckerx" class="v_td_modi">
                  <button type="button" class="modify_img_btn" title="Click the field below to pick the new date">MODIFY DATE  <img src="../shared/img/icons/icn-edit-teal.svg" class="td_edit_img desktop"/></button>
                <input autocomplete="off" type="text" class="datepicker form-control-sm" name="newdate" placeholder="" onchange="modify_date(this.value,' . $m_voucher . ',' . $m_partner . ')"></td>
                ';
       } elseif ($box_voucher_status == 4) {
      ...
      ?>
       <table class="table   table-borderless">
        ...
        <tbody>
         ...
         <tr class="voucher_list_table_mob_tr">
          <td class="v_td_a">Customer Name</td>
          <td><?= $c_user_data->fname ?></td>
         </tr>
         <tr class="voucher_list_table_mob_tr">
          <td class="v_td_a">Customer Surname</td>
          <td><?= $c_user_data->sname ?></td>
         </tr>
         <tr class="voucher_list_table_mob_tr">
          <td class="v_td_a">Date Redeemed</td>
          <td><?= $date_redeemed ?></td>
         </tr>
         <tr class="voucher_list_table_mob_tr">
         ...
         <tr class="voucher_list_table_mob_tr">
          <td class="v_td_a">Partner Reimbursement</td>
          <td>Ksh <?= number_format($ptn_pay, 2) ?></td>
         </tr>
         <tr class="v_td_100">
      ...
      <!-- <br>
            <table class="table  voucher_list_table_mob2 table-borderless">
              ...
              <tbody>
                <tr>
                  <td class="">SPA EXPERIENCE</td>
                  <td class="canc_mob_text">CANCELLED</td>
                </tr>
                <tr>
                  <td class="">SPORTS & ADVENTURE</td>
                  <td class="reed_mob_text">REDEEMED</td>
                </tr>
                <tr>
  ...
  <div class="modal-content">
   <div class="modal-body text-center">
    <div class="col-md-12 text-center forgot-dialogue-borderz">
     ...
     <form autocomplete="off" name="voucher_val" method="post">
      <?= $util->msg_box() ?>
      <div class="row">
       <div class="col-md-6">
        <div class="form-group">
  ...
  <div class="modal-content">
   <div class="modal-body text-center">
    <div class="col-md-12 text-center forgot-dialogue-borderz">
     ...
     <form autocomplete="off" name="modify_book_frm" method="post">
      <?= $util->msg_box('m') ?>
      <div class="row">
  ...
  <script>
   $(document).ready(function() {
    cancell_voucher_pop = function(vcode) {
     waitingDialog.show('opening... Please wait', {
      headerText: '',
      headerSize: 6,
      dialogSize: 'sm'
     });
    ...
    modify_voucher_booking = function(FormId) {
     waitingDialog.show('modifying... Please wait', {
      headerText: '',
      headerSize: 6,
      dialogSize: 'sm'
     });
