...
<meta name="description" content="Become A Happybox Partner. HappyBox issues vouchers to its customers via its website. Each voucher is an opportunity to suggest an appropriate set of experiences for the recipient of the voucher.">
<meta name="robots" content="index, follow">
<link rel="canonical" href="https://happybox.ke/partner/become-a-partner.php">
<meta property="og:locale" content="en_US">
<meta property="og:type" content="website">
<meta property="og:title" content="HappyBox">
<meta property="og:description" content="Become A Happybox Partner. HappyBox issues vouchers to its customers via its website. Each voucher is an opportunity to suggest an appropriate set of experiences for the recipient of the voucher.">
<meta property="og:url" content="https://happybox.ke/partner/become-a-partner.php">
...
<section  class="blue_band text-center"> <h2 class="">HAPPYBOX PARTNER PORTAL</h2> </section>
<!--desktop-->
<section  class="green_strip text-center desktop_view"> <h4 class="partner_blue2">Becoming a HAPPYBOX partner means you are always a winner!</h4> </section>
...
<!--mobile-->
<section  class="green_strip text-center mobile_view"> <h4 class="partner_blue2 mob_bold">Becoming a HAPPYBOX partner means<br>
	you are always a winner!</h4> </section>
	...
	<div class="container">
		<div class="row justify-content-center become_boxes">
			<div class="col-12 no_padd">
				<div class="become_card become_card1">
					<div class="become_card_txt">
						Free advertising year round on our website<br>
						and in our boxes
					</div>
				</div>
			</div>
		...
		<div class="row ">
			<div class="col-md-12 col-lg-6">
				<div class="card become_part_card">
					...
					<div class="become_part_card_txt">
						<h4> Sign your contract and annex</h4> We will support you in defining the best set of services you want to promote.
					</div>
				</div>
			</div>
			<div class="col-md-12 col-lg-6">
				<div class="card become_part_card">
					...
					<div class="become_part_card_txt">
						<h4> Check and control your promoted services</h4> Through your Partner Portal personalised access.
					</div>
				</div>
			</div>
			<!--row 2-->
			<div class="col-md-12 col-lg-6">
				<div class="card become_part_card">
					...
					<div class="become_part_card_txt">
						<h4> Your services are published and promoted</h4> On our website and our boxes.
					</div>
				</div>
			</div>
			<div class="col-md-12 col-lg-6">
				<div class="card become_part_card">
					...
					<div class="become_part_card_txt">
						<h4> Your customers book </h4> Save the voucher numbers through your partner portal.
					</div>
				</div>
			</div>
			<!--3-->
			<div class="col-md-12 col-lg-6">
				<div class="card become_part_card">
					...
					<div class="become_part_card_txt">
						<h4> Execute the service</h4> Get paid once the service has been executed.
					</div>
				</div>
			</div>
			<div class="col-md-12 col-lg-6">
				<div class="card become_part_card">
					...
					<div class="become_part_card_txt">
						<h4>Our Partner Care Team is available <br class="desktop_view">
						alongside you at each step.</h4>
					</div>
				</div>
			</div>
			<!--4-->
			<div class="col-md-6">
				<div class="card become_part_card card_step_blue">
					<div class="card_step_blue_txt text-white">
						These Partners trust us with their promotion
					</div>
				</div>
			</div>
		...
		<div class="modal-content">
			<div class="modal-body text-center">
				<div class="col-md-12 text-center forgot-dialogue-borderz">
					...
					<p class="forgot_des text-center">Thank you for your interest in a partnership with HAPPYBOX!<br>
						<br>
						Our Partner Care Team will review your submission and contact you.</p>
					<div>
