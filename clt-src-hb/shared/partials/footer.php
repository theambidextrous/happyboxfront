</div><footer class="text-white upper_footer">
     <div class="container">
 <div class="row ">
        <div class="col-md-3 upper_footer_col1">
		<span>Follow HappyBox</span>
		<ul>
                    <li><a href=""><img class="top-bar-nav-icon" src="<?=$util->ClientHome()?>/shared/img/icons/fb.svg"></a></li>
  
        <li><a href=""><img class="top-bar-nav-icon" src="<?=$util->ClientHome()?>/shared/img/icons/icn-ig.svg"></a></li>
          <li><a href=""><img class="top-bar-nav-icon" src="<?=$util->ClientHome()?>/shared/img/icons/icn-li.svg"></a></li>
    ...
    <div class="row lower_footer">
        ...
        <!--    <span class="copy_sign">&copy; </span>--> <span class="copy_text">&copy; 2020 HAPPYBOX</span>
