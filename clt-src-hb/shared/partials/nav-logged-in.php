<nav id="top" class="navbar navbar-expand-lg top-bar-logged-in text-white">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    Partner Company Name <i class="fas fa-angle-down"></i> <img src="../shared/img/icons/icn-partner-full-white.svg" class="user_icon">
      </a>
          ...
          <div class="card">
               <div class="card-body">
                  ...
                  <div class="col-2">
                   ...
                   <span class="email_dropdown">     name.surname@domain.com    </span>
                  </div>
                      </div>
...
<section class="container section_padding_top top_menu">
            <div class="row">
                <div class="col-md-12">
                  <ul>
                        <li><a href="partner-make-booking.php">Take A Booking</a></li>
                        <li><a href="partner-voucher-list.php">My Voucher List</a></li>
                        <li><a href="partner-experience.php">My Experience List</a></li>
