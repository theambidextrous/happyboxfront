...
<!--end discover our selection-->
 <section class="container section_padding_top contact_content">
  ...
  <input type="text" class="form-control" id="name" placeholder="Required Field">
</div>
                          <div class="form-group">
  <label for="email">Email Address</label>
  <input type="email" class="form-control" id="email" placeholder="Required Field">
</div>                     <div class="form-group">
  <label for="Enquiry">Enquiry</label>
  <input type="Enquiry" class="form-control" id="Enquiry" placeholder="Required Field">
</div>
 <div class="form-group">
  <label for="Details">Details</label>
  <textarea class="form-control" rows="3" id="Details" placeholder="Required Field"></textarea>
</div>
