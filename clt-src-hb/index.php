			...
			<div class="modal-body text-center">
				<div class="col-md-12 text-center">
					...
					<div class="action_btns desktop_view" >
						<a href="" data-dismiss="modal"> <img class="" src="<?=$util->ClientHome()?>/shared/img/btn-continue-shopping.svg"></a> <a href="user-dash-shoppingcart.php"> <img class="" src="<?=$util->ClientHome()?>/shared/img/btn-checkout.svg"></a>
					</div>
