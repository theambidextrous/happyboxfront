...
<section class="wellbeing_partners">
       <div class="container">
           ...
           <div class="col-md-3">
               <div class="partner_logo gas_table_border">
                 ...
                 <div class="table-responsive">
                     ...
                     <table class="cat_well_table table table-bordered">
                         <tr>
                              <td class="td_cat_a">
                                 <table>
                                     <tr><td class="inner_td_gray"><h6>LE CAFE DE PARIS</h6></td></tr>
                                        <tr><td class="inner_light_blue"><h6 >  NAIROBI | KILIMANI</h6></td></tr>
                                 </table>
                               ...
                               Le Café de Paris is a warm, friendly Parisian style bistro with a great selection of French inspired food to match. Bon Appétit!
