...
<html lang="en">
    ...
    <head>
        ...
        <title>Happy Box:: User Reset Password </title>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 text-center">
                        <h5 class="">
                            To reset your HAPPYBOX account password you will need to complete the following form.</h5>
                    </div>
                    ...
                    <div class="card user_login_card user_create_l">
                        <div class="card-body text-center">
                            ...
                            <form method="post">
                                ...
                                <i><span>1. Be at least 8 characters in length.</span> <span>2. Include at least one upper case letter.</span><span>3. Include one number.</span><span> 4. Include one special character.</span></i>
                                <br><br><br>
