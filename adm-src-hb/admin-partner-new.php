                        ...
                        <form class="filter_form" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="inc/reg number" name="business_reg_no" class="form-control rounded_form_control" id="select_box_type" value="<?=$_SESSION['frm']['business_reg_no']?>"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="BoxType" class="col-form-label">Partner location</label>
                                    <input type="text" placeholder="location" name="location" class="form-control rounded_form_control" id="select_box_type" value="<?=$_SESSION['frm']['location']?>"/>
                                </div>
                                <div class="col-md-6">
                                    <label for="BoxType" class="col-form-label">Partner Business category</label>
                                    <input type="text" placeholder="business category" name="business_category" class="form-control rounded_form_control" id="select_box_type" value="<?=$_SESSION['frm']['business_category']?>"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
