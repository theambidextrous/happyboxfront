    ...
    <body>
        ...
        <section class=" status_bar ">
            ...
            <div class="container justify-content-around">
                <div class="row ">
                    <div class="col-md-2">
                        <a href="admin-box-all.php" class="btn generate_rpt btn-block is_active">Inactive</a>
                    </div>
                    <div class="col-md-2">
                        <a href="admin-box-all-active.php" class="btn generate_rpt btn-block">Active</a>
                    </div>
                </div>
            </div>
        </section>
