        ...
        <section class=" status_bar ">
            <div class="container justify-content-around">
                ...
                <div class="row ">
                    ...
                    <div class="col-md-2">
                        <a href="admin-box-inventory-purchased.php" style="color:#c20a2b;" class="btn generate_rpt btn-block">PURCHASED</a>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="container">
                <div class="row ">
                    <div class="col-md-12 ">
                        ...
                        <br>
                        <small class="text-muted">All boxes that have been purchased by customer buyers. Includes those that have been redeemed</small>
                        <table class="table table_data1 table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach($all_happyboxes as $hbox ):
                                    if(in_array($hbox['is_active'], [3,4])){
                                ?>
                                <tr>
